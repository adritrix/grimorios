...
dirPaquete="/backups/semanal/postgresql/data/"
...
##Nombre del paquete
nombrePaquete="postgresDump_semanal"
...
dirDatos="/tmp/postgresdump/full/"

mkdir -p ${dirDatos}
##Comando de volcado de las bases de datos en el directorio de donde se va hacer el empaquetado
sudo -u postgres pg_dumpall >  ${dirDatos}full_databases.sql 2>> $archivoLog
...
##Comprueba el numero de elementos en el directorio de la copia de seguridad y si es mayor a 2, eliminara el mas antiguo y lo sincronizara en la nube
...
##Direccion donde se va a crear el paquete
dirPaquete="/backups/semanal/postgresql/conf/"
